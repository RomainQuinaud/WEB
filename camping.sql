...
(1, 'Dauphin', 1,'../img/logement/logement_dauphin.jpg'),
(1, 'Baleine', 1,'../img/logement/logement_baleine.jpg'),
(1, 'Manchot', 1,'../img/logement/logement_manchot.jpg'),
(1, 'Calamar', 1,'../img/logement/logement_calamar.jpg'),
(1, 'Phoque', 1,'../img/logement/logement_phoque.jpg'),
(1, 'Méduse', 1,'../img/logement/logement_meduse.jpg'),
(1, 'Corail', 1,'../img/logement/logement_corail.jpg'),
(1, 'Epaulard', 1,'../img/logement/logement_epaulard.jpg'),
(1, 'Marsouin', 1,'../img/logement/logement_marsouin.jpg'),
(2, 'Lion de mer', 1,'../img/logement/logement_lion_de_mer.jpg'),
(2, 'Pieuvre', 1,'../img/logement/logement_pieuvre.jpg'),
(2, 'Étoile de mer', 1,'../img/logement/logement_etoile_de_mer.jpg'),
(2, 'Orque', 1,'../img/logement/logement_orque.jpg'),
...
ALTER TABLE logement ADD UNIQUE(nomlogement);
/*!40101 SET CHARACTER_SET_CLIENT=@OLD_CHARACTER_SET_CLIENT */;
/*!40101 SET CHARACTER_SET_RESULTS=@OLD_CHARACTER_SET_RESULTS */;
/*!40101 SET COLLATION_CONNECTION=@OLD_COLLATION_CONNECTION */;


CREATE TABLE pourcent_reduc
(
    avance VARCHAR() PRIMARY KEY NOT NULL,
    pourcent INT NOT NULL
);
ALTER TABLE camping.pourcent_reduc ADD CONSTRAINT unique_avance UNIQUE (avance);